...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CFa-jxkf.js
...
var styles_default = "/assets/styles-D4XCrAVq.css";
var APP_NAME = "Windoors 11.2 Caretaker";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Keep your Windoors 11.2 PC healthy — run maintenance tools before system health hits zero."
			},
			...[]
		],
		links: [{
...
var $$splitComponentImporter = () => import("./routes-BZdN8-ol.mjs");
